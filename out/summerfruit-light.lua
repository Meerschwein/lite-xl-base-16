...
style.scrollbar        = { common.color '#000000' }
style.dim              = { common.color '#000000' }
style.text             = { common.color '#101010' }
style.caret            = { common.color '#101010' }
style.scrollbar2       = { common.color '#101010' } -- Hovered
style.line_number2     = { common.color '#101010' } -- With cursor
...
style.syntax['normal']   = { common.color '#101010' }
...
style.syntax['operator'] = { common.color '#101010' } -- = + - / < >
