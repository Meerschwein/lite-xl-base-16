...
style.accent           = { common.color '#0e5a94' }
...
style.syntax['symbol']   = { common.color '#eb008a' }
style.syntax['comment']  = { common.color '#505050' }
style.syntax['keyword']  = { common.color '#b31e8d' } -- local function end if case
style.syntax['keyword2'] = { common.color '#f8ca12' } -- self int float
style.syntax['number']   = { common.color '#f29333' }
style.syntax['literal']  = { common.color '#f29333' } -- true false nil
style.syntax['string']   = { common.color '#37b349' }
style.syntax['operator'] = { common.color '#d0d0d0' } -- = + - / < >
style.syntax['function'] = { common.color '#0e5a94' }
