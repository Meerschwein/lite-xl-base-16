...
style.accent           = { common.color '#90bee1' }
...
style.syntax['symbol']   = { common.color '#ff7f7b' }
style.syntax['comment']  = { common.color '#777777' }
style.syntax['keyword']  = { common.color '#efb3f7' } -- local function end if case
style.syntax['keyword2'] = { common.color '#ffd67c' } -- self int float
style.syntax['number']   = { common.color '#ffbf70' }
style.syntax['literal']  = { common.color '#ffbf70' } -- true false nil
style.syntax['string']   = { common.color '#beda78' }
style.syntax['operator'] = { common.color '#cccccc' } -- = + - / < >
style.syntax['function'] = { common.color '#90bee1' }
