...
style.accent           = { common.color '#a0a7d2' }
...
style.syntax['symbol']   = { common.color '#fa8480' }
style.syntax['comment']  = { common.color '#b8b8b8' }
style.syntax['keyword']  = { common.color '#c8a0d2' } -- local function end if case
style.syntax['keyword2'] = { common.color '#ffdc61' } -- self int float
style.syntax['number']   = { common.color '#ffaa61' }
style.syntax['literal']  = { common.color '#ffaa61' } -- true false nil
style.syntax['string']   = { common.color '#a0d2c8' }
style.syntax['operator'] = { common.color '#383838' } -- = + - / < >
style.syntax['function'] = { common.color '#a0a7d2' }
