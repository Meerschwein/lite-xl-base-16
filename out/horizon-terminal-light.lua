...
style.syntax['keyword2'] = { common.color '#FADAD1' } -- self int float
style.syntax['number']   = { common.color '#F9CEC3' }
style.syntax['literal']  = { common.color '#F9CEC3' } -- true false nil
