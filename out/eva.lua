...
style.accent           = { common.color '#15f4ee' }
...
style.syntax['keyword2'] = { common.color '#ffff66' } -- self int float
style.syntax['number']   = { common.color '#ff9966' }
style.syntax['literal']  = { common.color '#ff9966' } -- true false nil
style.syntax['string']   = { common.color '#66ff66' }
style.syntax['operator'] = { common.color '#9fa2a6' } -- = + - / < >
style.syntax['function'] = { common.color '#15f4ee' }
